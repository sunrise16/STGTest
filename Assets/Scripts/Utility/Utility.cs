...
public class Utility : Singleton<Utility>
{
    ...
    public Vector2 GetPosition(GameObject pObject, float fRadius, float fAngle)
    {
        Vector2 vObjectPosition = pObject.GetComponent<Transform>().position;
    ...
    public Vector2 GetPosition(Vector2 vObjectPosition, float fRadius, float fAngle)
    {
        float fRadian = fAngle * Mathf.PI / 180;

        return new Vector2(vObjectPosition.x + (fRadius * Mathf.Cos(fRadian)), vObjectPosition.y + (fRadius * Mathf.Sin(fRadian)));
    }
    public Vector2 GetRandomPosition(GameObject pObject, float fRadius)
    {
        Vector2 vObjectPosition = pObject.GetComponent<Transform>().position;
    ...
    public Vector2 GetRandomPosition(Vector2 vObjectPosition, float fRadius)
    {
        float fAddPositionX = Random.Range(-fRadius, fRadius);
        float fAddPositionY = Mathf.Sqrt(Mathf.Pow(fRadius, 2.0f) - Mathf.Pow(fAddPositionX, 2.0f));
    ...
    public Vector2 GetRandomPosition(GameObject pObject, float fMargin, float fRadius)
    {
        Vector2 vObjectPosition = pObject.GetComponent<Transform>().position;
    ...
    public Vector2 GetRandomPosition(Vector2 vObjectPosition, float fMargin, float fRadius)
    {
        float fAddPositionX, fAddPositionY;
    ...
    public Vector2 GetRandomMaxPosition(GameObject pObject, float fRadius)
    {
        Vector2 vObjectPosition = pObject.GetComponent<Transform>().position;
        float fAddPositionX = Random.Range(-fRadius, fRadius);
        float fAddPositionY = Mathf.Sqrt(Mathf.Pow(fRadius, 2.0f) - Mathf.Pow(fAddPositionX, 2.0f));
    ...
    public Vector2 GetRandomMaxPosition(Vector2 vObjectPosition, float fRadius)
    {
        float fAddPositionX = Random.Range(-fRadius, fRadius);
        float fAddPositionY = Mathf.Sqrt(Mathf.Pow(fRadius, 2.0f) - Mathf.Pow(fAddPositionX, 2.0f));
        int iPositionMultiply = Random.Range(0, 2);
